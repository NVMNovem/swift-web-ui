...
@Test func layoutVisualAndPositionModifiersRenderSwiftCSSProperties() {
    ...
    #expect(layout.cssString().contains("align-self: start"))
    #expect(layout.cssString().contains("flex-grow: 0"))
    #expect(layout.cssString().contains("flex-shrink: 1"))
    #expect(layout.cssString().contains("flex-basis: auto"))
    ...
    #expect(visual.cssString().contains("aspect-ratio: 3 / 2"))
    #expect(visual.cssString().contains("object-position: top right"))
    #expect(visual.cssString().contains("border-bottom: 1px solid red"))
    #expect(visual.cssString().contains("word-break: break-word"))
    ...
    let allEdges = HTMLRenderer().renderView(Text("All").border(.all, "1px solid red"))
    #expect(allEdges.cssString().contains("border: 1px solid red"))
    #expect(!allEdges.cssString().contains("border-top"))

    let twoEdges = HTMLRenderer().renderView(Text("Two").border([.leading, .trailing], "2px solid red"))
    #expect(twoEdges.cssString().contains("border-left: 2px solid red"))
    #expect(twoEdges.cssString().contains("border-right: 2px solid red"))
    #expect(!twoEdges.cssString().contains("border-top"))
}
