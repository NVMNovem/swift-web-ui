...
| Font | `FontSize`, `FontWeight`, `LineHeight`, and related CSS properties. | `FontToken`, a semantic bundle of font declarations. | Keep `FontToken` in SwiftWebUI. It provides UI-level token grouping rather than duplicating one CSS property. |
